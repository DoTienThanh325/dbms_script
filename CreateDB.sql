...
CREATE TABLE COMMENT_LIKES (
    ...
    comment_id INT NOT NULL FOREIGN KEY REFERENCES SONG_COMMENTS(comment_id) ON DELETE NO ACTION,
...
CREATE TABLE SONG_LIKES (
    id INT IDENTITY(1,1) PRIMARY KEY,
    user_id INT NOT NULL FOREIGN KEY REFERENCES USERS(user_id) ON DELETE NO ACTION,
    song_id INT NOT NULL FOREIGN KEY REFERENCES SONGS(song_id) ON DELETE NO ACTION,
    liked_at DATETIME DEFAULT GETDATE(),
